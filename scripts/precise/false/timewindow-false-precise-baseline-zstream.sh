...
mkdir timewindow-false-precise-baseline-zstream
...
java edu.umass.cs.sase.util.ResultReader timewindow-false-precise-baseline-zstream >>timewindow-false-precise-baseline-zstream/result.txt
